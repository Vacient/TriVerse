...
export const DESTINATIONS = [
  {
    ...
    foods: [
      { name: "Lunch at Supanniga", desc: "Riverside dining featuring authentic Eastern Thai recipes. Recommendation: Moo Cha Muang.", cost: 12, tags: ["Food"], scene: "dining" },
      { name: "Dinner at Jay Fai", desc: "Michelin-starred street food legend. Famous for crab omelets. Expect a wait if no reservation.", cost: 26, tags: ["Food", "Nightlife"], scene: "street-food" },
      { name: "Chinatown Food Crawl", desc: "Grilled squid, dim sum and mango sticky rice under Yaowarat's neon signs.", cost: 10, tags: ["Food", "Nightlife"], scene: "street-food" },
      { name: "Thipsamai Pad Thai", desc: "The legendary shrimp-oil pad thai wrapped in egg — a pilgrimage for food lovers.", cost: 9, tags: ["Food"], scene: "street-food" },
      { name: "Canal-Side Brunch", desc: "Boat noodles and iced Thai tea on the banks of the khlong.", cost: 8, tags: ["Food"], scene: "dining" },
      { name: "Or Tor Kor Market Tasting", desc: "Grazing through Thailand's best fresh market with a guide.", cost: 11, tags: ["Food", "Shopping"], scene: "market" },
    ],
    transfers: [
  ...
  },
  {
    ...
    foods: [
      { name: "Omakase Sushi Counter", desc: "Ten pieces of seasonal nigiri, served piece by piece.", cost: 30, tags: ["Food"], scene: "dining" },
      { name: "Ramen Alley Slurp", desc: "Tonkotsu broth simmered 18 hours. Extra chashu recommended.", cost: 9, tags: ["Food"], scene: "street-food" },
      { name: "Izakaya Izakaya Night", desc: "Yakitori skewers, highballs and counter banter.", cost: 18, tags: ["Food", "Nightlife"], scene: "street-food" },
      { name: "Depachika Bento Picnic", desc: "Basement food hall bento assembled for a park picnic.", cost: 13, tags: ["Food"], scene: "market" },
    ],
    transfers: [
  ...
  },
  {
    ...
    foods: [
      { name: "Warung Nasi Campur", desc: "A banana-leaf plate of lawar, sate lilit and crispy tempeh.", cost: 6, tags: ["Food"], scene: "street-food" },
      { name: "Babib Guling Feast", desc: "Bali's legendary roast suckling pig, carved to order.", cost: 9, tags: ["Food"], scene: "street-food" },
      { name: "Sunset Seafood at Jimbaran", desc: "Tables in the sand, grilled snapper and sambal matah.", cost: 15, tags: ["Food", "Nightlife"], scene: "dining" },
      { name: "Jungle Café Brunch", desc: "Smoothie bowls and single-origin coffee above the Ayung river.", cost: 10, tags: ["Food"], scene: "dining" },
    ],
    transfers: [
  ...
  },
  {
    ...
    foods: [
      { name: "KBBQ at Mapo Galmaegi", desc: "Charcoal-grilled pork belly, ssam wraps and soju shots.", cost: 16, tags: ["Food", "Nightlife"], scene: "street-food" },
      { name: "Gwangjang Market Bites", desc: "Bindaetteok pancakes and tteokbokki from Netflix-famous stalls.", cost: 8, tags: ["Food"], scene: "market" },
      { name: "Chimaek by the River", desc: "Crispy fried chicken and beer, the Seoul picnic classic.", cost: 11, tags: ["Food"], scene: "street-food" },
      { name: "Café Street Latte", desc: "Third-wave espresso in a converted hanok.", cost: 5, tags: ["Food"], scene: "dining" },
    ],
    transfers: [
  ...
  },
  {
    ...
    foods: [
      { name: "Maxwell Hawker Feast", desc: "Hainanese chicken rice from the stall that beat Gordon Ramsay.", cost: 7, tags: ["Food"], scene: "street-food" },
      { name: "Newton Circus Chilli Crab", desc: "Crab in fiery tomato sauce, mantou buns for dipping.", cost: 20, tags: ["Food", "Nightlife"], scene: "street-food" },
      { name: "Katong Laksa Lunch", desc: "Spiced coconut broth noodles, cut and eaten by spoon.", cost: 6, tags: ["Food"], scene: "dining" },
      { name: "Kaya Toast Breakfast", desc: "Charcoal toast, kaya jam and a soft egg ritual.", cost: 4, tags: ["Food"], scene: "dining" },
    ],
    transfers: [
  ...
  },
  {
    ...
    foods: [
      { name: "Khao Soi at Khao Soi Khun Yai", desc: "The city's best coconut curry noodles, extra pickled mustard.", cost: 4, tags: ["Food"], scene: "street-food" },
      { name: "Night Bazaar Grazing", desc: "Grilled river fish, sai oua sausage and mango sticky rice.", cost: 8, tags: ["Food", "Nightlife"], scene: "market" },
      { name: "Farm-to-Table Dinner", desc: "Northern tasting menu at an organic farm restaurant.", cost: 19, tags: ["Food"], scene: "dining" },
      { name: "Baan Kang Wat Brunch", desc: "Artisan village brunch among studios and gardens.", cost: 7, tags: ["Food"], scene: "dining" },
    ],
    transfers: [
